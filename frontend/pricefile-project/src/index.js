...
function render(props) {
  ...
  const dom = container ? container.querySelector('#pricefile') : document.querySelector('#pricefile')
...
export async function unmount(props) {
  const { container } = props;
  createRoot(container ? container.querySelector('#pricefile') : document.querySelector('#pricefile')).unmount();
